#include "../header/App.h" // include our App class
...
int main() { // main is the entry point for every C++ program
	...
	int result = App::Instance()->RunApp();
...
// ctrl + F Open find dialog the most useful shortcut of all in large projects
// ctrl + H Open find and replace dialog
// Hold down Alt and drag to create a rectangular selection
// Hold down Alt on any line with the cursor at the end to move lines up and down with the up and down arrow keys
